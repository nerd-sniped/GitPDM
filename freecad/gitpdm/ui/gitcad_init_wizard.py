...
class GitCADInitWizard(QtWidgets.QDialog):
    ...
    2. Initializing configuration (.gitpdm/config.json)
    
    NOTE: This wizard is deprecated as of Sprint 4. Use native GitPDM configuration instead.
    ...
    def _find_default_reference(self):
        """Try to find a default GitCAD reference directory automatically."""
        # Look for FreeCAD_Automation in addon directory
        # NOTE: This wizard is deprecated and will be removed in Sprint 5
        potential_paths = [
            Path(__file__).parent.parent.parent.parent / "FreeCAD_Automation",
        ]
        ...
        self.status_label.setText(
            ...
            "FreeCAD_Automation folder was not found.\n"
            "This feature is deprecated and will be removed in Sprint 4."
        )
        ...
        self.manual_setup_widget.setHtml(
            "<b>Manual Setup:</b><br>"
            "1. Use the native GitPDM functionality (recommended)<br>"
    ...
    def _create_config(self):
        ...
        try:
            ...
            log.info(f"Created config.json at {self.repo_root / '.gitpdm' / 'config.json'}")
        except Exception as e:
