...
class GitHubAuthHandler:
    ...
    def _request_device_code_sync(self, client_id, auth_config):
        ...
        from freecad.gitpdm.auth.oauth_device_flow import request_device_code
    ...
    def _poll_for_token_sync(self, client_id, device_code_response, auth_config):
        ...
        from freecad.gitpdm.auth.oauth_device_flow import poll_for_token
    ...
    def _on_token_received(self, token_response):
        ...
        try:
            ...
            from freecad.gitpdm.auth import scope_validator
    ...
    def _on_token_poll_error(self, error):
        ...
        from freecad.gitpdm.auth.oauth_device_flow import DeviceFlowError
