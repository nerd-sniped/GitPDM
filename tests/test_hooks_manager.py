...
from freecad_gitpdm.git.hooks_manager import HooksManager
...
class TestHookInstallation:
    ...
    def test_install_single_hook(self, temp_repo):
        ...
        assert 'from freecad_gitpdm.git.hooks import pre_commit_hook' in content
...
class TestConvenienceFunctions:
    ...
    def test_install_hooks_in_repo(self, temp_repo):
        ...
        from freecad_gitpdm.git.hooks_manager import install_hooks_in_repo
    ...
    def test_uninstall_hooks_from_repo(self, temp_repo):
        ...
        from freecad_gitpdm.git.hooks_manager import (
